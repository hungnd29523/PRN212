...
namespace AutomobileWinApp
{
    public partial class frmCarManagement : Form
    {
        ...
        private void frmCarManagement_Load(object sender, EventArgs e)
        {
            ...
            dgvCarList.CellDoubleClick += DgbCarList_CellDoubleClick;
        }
        private void DgbCarList_CellDoubleClick(object sender, DataGridViewCellEvantArgs e)
        {
        ...
        private frmCarDetails GetCarObject()
        {
            Car car = null;
            try
            {
